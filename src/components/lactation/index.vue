  ...
  <div class="laction">
    ...
    <div class="primary-left">
     ...
     <!--<div class="fenge-line"></div>-->
      ...
      <!--</div>-->
      <!--<div class="fenge-line"></div>-->
     <!--测试 <div v-for="(cuirs, index) in nurseinfo" :key="index">{{cuirs.id}}</div>-->
      <div><img :src="api+message" /></div>
      <div class="modules04">
        <div class="title">
          <h2>催乳师风采</h2>
        </div>
        <ul class="modules04-ul">
          <li v-for="(cuirs, index) in nurseinfo" :key="index">
            <div class="content01">
              <p>
                {{cuirs.ename}}&nbsp;&nbsp;&nbsp;&nbsp;{{cuirs.eage}}岁
            ...
            <div class="person">
              <a>
           <img class="nurse-imgs" :src="api+cuirs.img">
            </a>
            </div>
